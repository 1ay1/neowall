...
#ifndef HAVE_GLES3
    (void)output;  /* Unused when GLES3 not available */
...
bool gles30_create_shader_program(const char *vertex_src, const char *fragment_src,
                                   GLuint *program) {
#ifndef HAVE_GLES3
    (void)vertex_src;    /* Unused when GLES3 not available */
    (void)fragment_src;  /* Unused when GLES3 not available */
    (void)program;       /* Unused when GLES3 not available */
    log_error("OpenGL ES 3.0 not available");
    return false;
#else
...
#ifndef HAVE_GLES3
    (void)output;  /* Unused when GLES3 not available */
    log_error("OpenGL ES 3.0 rendering not available");
    return false;
#else
    if (!output) {
        return false;
...
/* Apply OpenGL ES 3.0 optimizations for shader rendering */
...
#ifndef HAVE_GLES3
    (void)output;      /* Unused when GLES3 not available */
    (void)num_targets; /* Unused when GLES3 not available */
    log_error("MRT requires OpenGL ES 3.0");
    return false;
#else
...
#ifndef HAVE_GLES3
    (void)output;  /* Unused when GLES3 not available */
    log_error("Shadertoy features require OpenGL ES 3.0");
    return false;
#else
    if (!output) {
        return false;
