...
struct zwlr_foreign_toplevel_manager_v1_listener {
	 ...
	 * It is emitted for all toplevels, regardless of the app that has
	 * created them.
	 *
	 ...
	 * to the zwlr_foreign_toplevel_manager_v1. The server will destroy
	 * the object immediately after sending this request, so it will
	 * become invalid and the client should free any resources associated
	 * with it.
	 */
...
struct zwlr_foreign_toplevel_handle_v1_listener {
	 ...
	 *
	 * This event is emitted whenever the toplevel stops being visible
	 * on the given output. It is guaranteed that an entered-output event
	 ...
	 *
	 * This event is emitted immediately after the toplevel state changes.
	 * The state is an array of uint32_t, each element being one of the
	...
	void (*done)(void *data,
		     struct zwlr_foreign_toplevel_handle_v1 *zwlr_foreign_toplevel_handle_v1);
	/**
	 * this toplevel has been closed
	 *
	 * This event means the toplevel has been closed. It provides no
	 * guarantee that requests sent against the toplevel are actually
	 * applied. The client should release any resources associated with
	 * this toplevel.
	 */
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * Send a request to the toplevel to close itself.
 */
static inline void
 ...
 * minimize animation. The client is however not required to set this, in
 * which case the compositor is free to decide some default value.
 *
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * Requests that the toplevel be fullscreen on the given output. If the
 * output is NULL, the compositor will choose the output and possibly the
 * position of the fullscreen view.
 */
static inline void
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * Requests that the toplevel be unfullscreened.
 */
static inline void
