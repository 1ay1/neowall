...
static const char *neowall_glsl_stdlib4 =
    ...
    "vec3 nwTermCell(ivec2 cell, vec2 frac, float cw, float ch){\n"
...
static const char *neowall_glsl_stdlib5 =
    ...
    "    return nwTermCell(cell, frac, cw, ch);\n"
    "}\n"
    "\n";
...
static const char *neowall_glsl_stdlib6 =
    ...
    "#endif\n"
    "\n"
    "// nwTermSampleGrid: nwTerm at an arbitrary uv, clamped so the CRT warp and\n"
    "// bloom taps that stray off the unit square read black (the bezel) instead\n"
    "// of wrapping the far edge of the grid back in.\n"
